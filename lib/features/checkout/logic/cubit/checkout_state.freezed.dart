...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CheckoutState<T>);
}
...
/// @nodoc
class $CheckoutStateCopyWith<T,$Res>  {
$CheckoutStateCopyWith(CheckoutState<T> _, $Res Function(CheckoutState<T>) __);
}


/// Adds pattern-matching-related methods to [CheckoutState].
extension CheckoutStatePatterns<T> on CheckoutState<T> {
...
class _Initial<T> implements CheckoutState<T> {
  const _Initial();
...
class Loading<T> implements CheckoutState<T> {
  const Loading();
...
@override
String toString() {
  return 'CheckoutState<$T>.loading()';
}
...
class Success<T> implements CheckoutState<T> {
...
@override
String toString() {
  return 'CheckoutState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CheckoutStateCopyWith<T, $Res> {
...
class Error<T> implements CheckoutState<T> {
...
@override
String toString() {
  return 'CheckoutState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $CheckoutStateCopyWith<T, $Res> {
