...
class Error<T> implements ToppingsState<T> {
...
@override
String toString() {
  return 'ToppingsState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ToppingsStateCopyWith<T, $Res> {
