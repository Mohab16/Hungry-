...
class Error<T> implements SideOptionsState<T> {
...
@override
String toString() {
  return 'SideOptionsState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $SideOptionsStateCopyWith<T, $Res> {
