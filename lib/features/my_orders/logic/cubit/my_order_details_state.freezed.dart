...
part of 'my_order_details_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MyOrderDetailsState<T>);
}
...
/// @nodoc
class $MyOrderDetailsStateCopyWith<T,$Res>  {
$MyOrderDetailsStateCopyWith(MyOrderDetailsState<T> _, $Res Function(MyOrderDetailsState<T>) __);
}


/// Adds pattern-matching-related methods to [MyOrderDetailsState].
extension MyOrderDetailsStatePatterns<T> on MyOrderDetailsState<T> {
...
class _Initial<T> implements MyOrderDetailsState<T> {
  const _Initial();
...
@override
String toString() {
  return 'MyOrderDetailsState<$T>.initial()';
}
...
class Loading<T> implements MyOrderDetailsState<T> {
  const Loading();
...
@override
String toString() {
  return 'MyOrderDetailsState<$T>.loading()';
}
...
class Success<T> implements MyOrderDetailsState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of MyOrderDetailsState
...
@override
String toString() {
  return 'MyOrderDetailsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $MyOrderDetailsStateCopyWith<T, $Res> {
...
class Error<T> implements MyOrderDetailsState<T> {
...
@override
String toString() {
  return 'MyOrderDetailsState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $MyOrderDetailsStateCopyWith<T, $Res> {
