...
import 'package:hungry/core/themes/font_weight_helper.dart';
import 'package:hungry/core/themes/my_colors.dart';

class MyStyles {
  static TextStyle font20RobotoDarkGreenMedium = TextStyle(
    fontFamily: "Roboto",
    fontSize: 20.sp,
    fontWeight: FontWeightHelper.medium,
    color: MyColors.darkGreen,
  );
  static TextStyle font20LuckiestGuyRedBricksRegular = TextStyle(
  ...
  static TextStyle font15RobotoLightGreyMedium = TextStyle(
    fontFamily: "Roboto",
    fontSize: 15.sp,
    fontWeight: FontWeightHelper.medium,
    color: MyColors.lightGrey,
